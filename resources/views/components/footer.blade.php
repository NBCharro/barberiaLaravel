<div class="container-fluid">
    <footer class="pt-1 bg-dark" data-bs-theme="dark">
        <div class="container">
            <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
                ...
                <div class="mb-3 mb-md-0">&copy; 2023 Barberia Laravel</div>
                ...
                <ul class="nav col-md-4 justify-content-end list-unstyled d-flex">
                    ...
                    <li class="ms-3 ">
                        <a class="text-muted" href="mailto:info@barberialaravel.com">
                            <img src="{{ asset('images/rrss/email.png') }}"
                                alt="Email de contacto info@barberialaravel.com">
                        </a>
                    </li>
                    <li class="ms-3 ">
